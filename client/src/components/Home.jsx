...
function Home() {
  ...
  return (
    ...
    <>
              ...
              >
                <ul className="navbar-nav  ">
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link"
                      href="#about_section layout_padding"
                    >
                      About
                    </a>
                  </li>
      ...
      {/* experience section */}
      <section
        className="experience_section layout_padding"
      ...
      <section
        ...
        id="about_section layout_padding"
        style={{ background: "white" }}
      >
        <div className="container">
          <div className="row">
          ...
          <div className="detail-box">
            <h2>About Us</h2>
            <h3>Proxenix Web Dev Team 60 - 1 Months</h3>
            <p>
          ...
          <div className="container">
            <div className="info_top">
              <div className="info_logo">
                <img src={logo} alt="" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span>Proxenix - Feedback Collection System</span>
              </div>
            ...
            <div className="row">
              <div className="col-lg-9 col-md-10 mx-auto">
                <div className="info_contact layout_padding2"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="container-fluid footer_section ">
        <div className="container">
          <p>
            © <span id="displayDate" /> Made With ❤️ Team No 60
          </p>
        </div>
      </footer>
      {/* end  footer section */}
